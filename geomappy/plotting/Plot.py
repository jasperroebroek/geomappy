...
class Colorbar(Legend):
    ...
    def draw(self, ax, params):
        ...
        cbar_decorator(cbar, ticks=tick_locations, ticklabels=labels, fontsize=self._fontsize, **self._kwargs)
...
class LegendPatches(Legend):
    ...
    def draw(self, ax, params):
        ...
        if not isinstance(params.colors, type(None)):
            ...
            leg = ax.legend(handles=handles, title=self._title, fontsize=self._fontsize, **self._kwargs)
            if self._align_left:
